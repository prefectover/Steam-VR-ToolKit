namespace VRTK
{
    ...
    public class VRTK_SDK_Bridge
    {
        ...
        private static VRTK_BaseSDK activeSDK = null;

        public static string GetControllerElementPath(VRTK_BaseSDK.ControllerElelements element)
        {
        ...
        private static VRTK_BaseSDK GetActiveSDK()
        {
            if (activeSDK == null)
            {
                #if (SDK_STEAMVR)
                activeSDK = new VRTK_SteamVRSDK();
                #endif
            }
