...
namespace VRTK
{
    ...
    {
        public string bodyModelPath = VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.Body);
        public string triggerModelPath = VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.Trigger);
        public string leftGripModelPath = VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.GripLeft);
        public string rightGripModelPath = VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.GripRight);
        public string touchpadModelPath = VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.Touchpad);
        public string appMenuModelPath = VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.ApplicationMenu);
        public string systemMenuModelPath = VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.SystemMenu);
    }
    ...
    public class VRTK_ControllerActions : MonoBehaviour
    {
        ...
        public void InitaliseHighlighters()
        {
            ...
            AddHighlighterToElement(GetElementTransform(VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.ApplicationMenu)), objectHighlighter, elementHighlighterOverrides.appMenu);
            AddHighlighterToElement(GetElementTransform(VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.Body)), objectHighlighter, elementHighlighterOverrides.body);
            AddHighlighterToElement(GetElementTransform(VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.GripLeft)), objectHighlighter, elementHighlighterOverrides.gripLeft);
            AddHighlighterToElement(GetElementTransform(VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.GripRight)), objectHighlighter, elementHighlighterOverrides.gripRight);
            AddHighlighterToElement(GetElementTransform(VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.SystemMenu)), objectHighlighter, elementHighlighterOverrides.systemMenu);
            AddHighlighterToElement(GetElementTransform(VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.Touchpad)), objectHighlighter, elementHighlighterOverrides.touchpad);
            AddHighlighterToElement(GetElementTransform(VRTK_SDK_Bridge.GetControllerElementPath(VRTK_BaseSDK.ControllerElelements.Trigger)), objectHighlighter, elementHighlighterOverrides.trigger);
        }
